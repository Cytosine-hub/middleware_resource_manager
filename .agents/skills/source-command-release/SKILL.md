...
- Project root: `/Users/zhushihao/Projects/infra_portal`
...
cp backend/target/infra-portal-0.0.1-SNAPSHOT-exec.jar release/backend/
...
npm install --silent
npm run build
rm -rf /Users/zhushihao/Projects/infra_portal/release/frontend
cp -r dist /Users/zhushihao/Projects/infra_portal/release/frontend
```
...
```bash
mkdir -p /Users/zhushihao/Projects/infra_portal/release/db
```
...
```bash
mkdir -p /Users/zhushihao/Projects/infra_portal/release/docs
cp /Users/zhushihao/Projects/infra_portal/docs/startup-manual.md release/docs/
cp /Users/zhushihao/Projects/infra_portal/docs/production-deploy.md release/docs/
```
...
cd /Users/zhushihao/Projects/infra_portal
# frontend-only 示例
tar -czf release/infra-portal-<version>.tar.gz -C release frontend release.md

# backend + frontend 示例
tar -czf release/infra-portal-<version>.tar.gz -C release backend frontend release.md

# full 示例
tar -czf release/infra-portal-<version>.tar.gz -C release backend frontend db docs release.md
```

打包后必须检查 tar 内容，确认没有包含发布范围外的模块：

```bash
tar -tzf release/infra-portal-<version>.tar.gz | sed -n '1,80p'
```
