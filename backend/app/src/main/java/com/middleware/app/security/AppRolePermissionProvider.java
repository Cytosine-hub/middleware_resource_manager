package com.middleware.app.security;
...
@Service
public class AppRolePermissionProvider implements RolePermissionProvider {
    private static final String ROLE_SYS_ADMIN = "ROLE_SYS_ADMIN";

    private final RoleMapper roleMapper;

    public AppRolePermissionProvider(RoleMapper roleMapper) {
